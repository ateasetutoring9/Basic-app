    ...
    <footer className="py-12 px-4 border-t border-border bg-page">
      <div className="max-w-page mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
        ...
        <nav className="flex flex-wrap justify-center md:justify-end gap-x-8 gap-y-3">
          <Link href="/browse" className="text-small text-muted hover:text-fg transition-colors">
            Browse subjects
          </Link>
          <Link href="/login" className="text-small text-muted hover:text-fg transition-colors">
            Log in
          </Link>
          <Link href="/signup" className="text-small text-muted hover:text-fg transition-colors">
            Sign up
          </Link>
        </nav>
      </div>
